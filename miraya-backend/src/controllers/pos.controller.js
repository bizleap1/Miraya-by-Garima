...
export const getPosInvoiceReceiptPdf = async (req, res) => {
  try {
    ...
    // Header
    doc.fontSize(22).font('Helvetica-Bold').text('MIRAYA BY GARIMA', { align: 'center' });
    ...
    // Footer
    doc.moveDown(2);
    doc.fontSize(8).font('Helvetica-Oblique').text('Thank you for shopping at Miraya by Garima. For returns/exchanges, please bring this invoice within 7 days in original condition.', { align: 'center' });
