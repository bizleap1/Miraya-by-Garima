...
async function runProductionTestSuite() {
  console.log('================================================================');
  console.log('🧪 MIRAYA BY GARIMA — PRODUCTION ENTERPRISE TEST SUITE');
  console.log('================================================================\n');
  ...
  try {
    ...
    const initialMStock = initialMVariant.stock;
    ...
    const initialSStock = sVariant.stock;
    ...
    const secret = 'miraya_test_secret';
