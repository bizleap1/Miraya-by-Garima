        ...
        <div className="footer-top">
          ...
          <div className="footer-brand-section">
            ...
            <div className="footer-socials-new">
              <a href="https://www.instagram.com/miraya_official.in/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/profile.php?id=61591287333326" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
          ...
          <div className="footer-boutique-section">
            <div className="boutique-box">
              ...
              <div className="boutique-contact">
                <p>Email: <a href="mailto:mirayaofficial.in@gmail.com">mirayaofficial.in@gmail.com</a></p>
                <p>Phone: <a href="tel:+919271218156">+91 92712 18156</a></p>
              </div>
            </div>
          </div>
