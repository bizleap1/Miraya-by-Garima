/* 
  Save this file as lib/fabric.js or utils/fabric.js in your Next.js project.
  It is a pure WebGL implementation of the silk fabric transition.
*/
...
export function createFabric(canvas, texUrl) {
  ...
  function loadTexture(url) {
    ...
    gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, 1, 1, 0, gl.RGBA, gl.UNSIGNED_BYTE, new Uint8Array([90, 16, 8, 255]));
    const ready = new Promise((resolve) => {
      const img = new Image();
      img.crossOrigin = "anonymous"; // Important for Next.js if loading from different domain
      img.onload = () => {
        gl.bindTexture(gl.TEXTURE_2D, handle);
