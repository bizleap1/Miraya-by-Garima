...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <head>
        <link rel="icon" type="image/png" href="/logoR.png" />
        <link rel="shortcut icon" href="/logoR.png" />
        ...
        />
        {/* Google tag (gtag.js) */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-J7KTFXXW12"></script>
        <script
